  ...
  const features = [
    {
      ...
      description: "Custom ML models that learn from your data to provide predictive insights and automate complex decision-making processes."
    },
    {
      icon: Bot,
      title: "RPA Implementation",
      description: "Robotic Process Automation that eliminates repetitive tasks, reduces errors, and increases operational efficiency."
    },
    {
      icon: TrendingUp,
      title: "Predictive Analytics",
      description: "Advanced analytics that forecast trends, identify patterns, and enable proactive business decision-making."
    },
    {
      icon: MessageSquare,
      title: "Natural Language Processing",
      description: "AI-powered text and speech analysis for chatbots, sentiment analysis, and automated customer service."
    },
    {
      icon: Eye,
      title: "Computer Vision Applications",
      description: "Visual AI solutions for quality control, object recognition, and automated visual inspection systems."
    },
    {
      icon: Cpu,
      title: "AI-Powered Insights",
      description: "Intelligent data analysis that uncovers hidden patterns and provides actionable business intelligence."
    }
  ];
  ...
  const process = [
    {
      step: "01",
      title: "AI Assessment",
      description: "Evaluate current processes and identify automation opportunities with highest ROI potential."
    },
    {
      step: "02",
      title: "Solution Design",
      description: "Design custom AI and automation solutions tailored to your specific business requirements."
    },
    {
      step: "03",
      title: "Development",
      description: "Build and train AI models, develop automation workflows, and integrate with existing systems."
    },
    {
      step: "04",
      title: "Testing & Validation",
      description: "Comprehensive testing to ensure accuracy, reliability, and performance meet business standards."
    },
    {
      step: "05",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            >
              ...
              >
                Unlock the power of artificial intelligence to automate complex processes and drive innovation. Our AI solutions deliver intelligent automation, predictive insights, and machine learning capabilities that transform how you work.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-[#6B7280] max-w-3xl mx-auto">
              Our cutting-edge AI and automation solutions cover the full spectrum of intelligent 
              technologies, from machine learning to robotic process automation.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-[#6B7280] mb-8">
                Our AI and automation solutions deliver measurable business outcomes that 
                drive efficiency, accuracy, and competitive advantage. Experience the future 
                of intelligent business operations.
              </p>
              
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#16CA95] mb-2">80%</div>
                  <div className="text-[#6B7280]">Task Automation</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#16CA95] mb-2">95%</div>
                  <div className="text-[#6B7280]">Accuracy Rate</div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-white/70 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-[#6B7280] max-w-3xl mx-auto">
              A structured, proven approach that ensures successful AI and automation 
      ...
      <section className="py-20 bg-[#F8F9FA]/70 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-[#6B7280] max-w-3xl mx-auto">
              Discover how organizations across industries are leveraging our AI and automation 
              solutions to solve complex business challenges and drive innovation.
            </p>
          </motion.div>
            ...
            {useCases.map((useCase, index) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold text-[#373743]">{useCase}</span>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Let's discuss how our AI and automation expertise can help your organization 
              achieve breakthrough efficiency and competitive advantage through intelligent technology.
            </p>
