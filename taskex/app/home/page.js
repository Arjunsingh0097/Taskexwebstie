...
export default function Home() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Streamline and optimize your business operations with our comprehensive process improvement solutions. We analyze, redesign, and implement efficient workflows that drive productivity and reduce costs.",
      icon: Settings,
      features: ["Process Analysis & Optimization", "Workflow Automation", "Operational Excellence", "Cost Reduction Strategies"],
      color: "from-[#16CA95] to-[#BDF0E1]"
    }
  ];
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="relative overflow-hidden py-20 lg:py-32">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-white via-gray-50 to-[#BDF0E1]/30"></div>
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 0.6, delay: 0.2 }}
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-[#16CA95]/10 to-[#BDF0E1]/20 text-[#16CA95] px-6 py-3 rounded-full text-sm font-semibold mb-8 shadow-lg border border-[#16CA95]/20 relative overflow-hidden group"
              >
      ...
      {/* Stats Section */}
        <section className="py-20 bg-gradient-to-br from-gray-50 to-[#BDF0E1]/30 relative overflow-hidden">
          {/* Background Pattern */}
          <div className="absolute inset-0 opacity-5">
            <div className="absolute inset-0" style={{
              backgroundImage: `radial-gradient(circle at 1px 1px, #16CA95 1px, transparent 0)`,
        ...
        <section className="py-20 bg-gradient-to-br from-white via-gray-50 to-[#D1FAE5] relative overflow-hidden">
          {/* Animated Background Elements */}
                        ...
                        <div className={`relative bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/50 w-80 h-96 flex flex-col justify-between transform transition-all duration-500 ${
                          ...
                          <div className="text-center mb-6">
                            <div className="w-20 h-20 bg-gradient-to-br from-[#16CA95]/20 to-[#BDF0E1]/30 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                              ...
                              {service.title === "Business Process Services" && (
                                <Image
                          ...
                          <motion.button
                            ...
                            onClick={(e) => {
                              ...
                              const serviceRoutes = {
                                ...
                                "Business Process Services": "/services/business-process-services"
                              };
        ...
        <section className="py-20 bg-gradient-to-br from-gray-50 to-[#BDF0E1]/20 relative overflow-hidden">
          {/* Background Pattern */}
          <div className="absolute inset-0 opacity-5">
            <div className="absolute inset-0" style={{
              backgroundImage: `radial-gradient(circle at 1px 1px, #16CA95 1px, transparent 0)`,
